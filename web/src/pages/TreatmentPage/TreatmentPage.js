...
const TreatmentPage = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-md md:text-lg text-green-900 font-semibold mb-6"><IoTrailSign className="inline mr-2 align-middle h-6 w-6"/>Services organiques > Compostage des biodéchets</h1>
