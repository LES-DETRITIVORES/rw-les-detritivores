  ...
  return (
    <>
      ...
      <h1 className="text-md md:text-lg text-green-900 font-semibold mt-3 mb-6">
        <div>
          <IoServer className="inline mr-2 align-middle h-6 w-6"/>Données personnelles
        </div>
      </h1>
      <div>
        ...
        <div className="my-3 space-y-3 text-sm md:text-md lg:text-lg font-light">              
          <h3 className="font-bold uppercase underline">ARTICLE 1 : PRÉAMBULE</h3>
              ...
              <div class="paragraph">
                  ...
                  <br />
                  <a href="/legal" title="Accès à la page des mentions légales">https://www.les-detritivores.co/legal</a>
                  <br />
              </div>


              <h3 className="font-bold uppercase underline">ARTICLE 2 : PRINCIPES GÉNÉRAUX EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DE DONNÉES</h3>
              <div class="paragraph">
                  Conformément à la règlementation applicable, la collecte et le traitement des données des utilisateurs du site respectent les principes suivants :
                  <ul>
                      <li>Licéité, loyauté et transparence. A chaque fois que des données à caractère personnel seront collectées, il sera indiqué à l'utilisateur que ses données sont collectées, et pour quelles raisons ses données sont collectées ;</li>
                      <li>Finalités déterminées, explicites et légitimes : la collecte et le traitement des données sont exécutés pour répondre à un ou plusieurs objectifs déterminés dans la présente politique de confidentialité;</li>
                      ...
                      <li>Exactitude des données : les données sont exactes et sont effacées ou rectifiées sans tarder eu égard aux finalités pour lesquelles elles sont traitées ;</li>
                      <li>Conservation des données réduites dans le temps : les données sont conservées pour une durée limitée, dont l'utilisateur est informé ;</li>
              ...
              <div class="paragraph">
                  ...
                  Afin d'être licites, la collecte et le traitement des données à caractère personnel ne pourront intervenir que s'ils respectent au moins l'une des conditions ci-après énumérées :
                  <ul>
              ...
              <h3 className="font-bold uppercase underline">ARTICLE 3 : DONNÉES À CARACTÈRE PERSONNEL COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE</h3>

              <h4 className="font-semibold uppercase underline">A. DONNÉES COLLECTÉES ET TRAITÉES ET MODE DE COLLECTE</h4>
              <div class="paragraph">
              Les données à caractère personnel collectées sur le site les-detritivores.co sont les suivantes :
                  <ul>
                  <li>Société</li>
                  <li>Prénom, Nom</li>
                  <li>Téléphone</li>
              ...
              <div class="paragraph">
                  ...
                  <ul>
                  <li>Quand vous vous inscrivez sur le site pour recevoir une newsletter régulière afin de découvrir les réalisations et les actualités de l'agence.</li>
                  <li>Quand vous renseignez le formulaire de contact afin de rentrer en relation avec l'éditeur.</li>
                  </ul>
              </div>
              <div class="paragraph">
                  ...
                  <ul>
                  <li>Pour la newsletter : pendant une durée de trois ans à compter de leur collecte par LES DETRITIVORES ou du dernier contact émanant de votre part.</li>
                  <li>Pour le formulaire de contact : pendant une durée de trois ans à compter de leur collecte par LES DETRITIVORES ou du dernier contact émanant de votre part.</li>
                  </ul>
              </div>
              <div class="paragraph">
                  La collecte et le traitement des données répondent aux finalités suivantes :
                <ul>
                  <li>Les données sont collectées afin de pouvoir vous informer par le biais d'une newsletter, et de répondre à votre demande de prise de contact ;</li>
      <li>Vous permettre d'exercer vos droits ;</li>
      <li>Nous permettre d'exercer nos droits.</li>
                  </ul>
              </div>

              <h4 className="font-semibold uppercase underline">B. DESTINATAIRES DES DONNÉES</h4>
              <div class="paragraph">
                  Aucune de vos données personnelles n'est communiquée à un tiers susceptible de traiter celles-ci à des fins commerciales.
              </div>
              <div class="paragraph">
                  Dans le strict respect des finalités exposées ci-avant, nous pourrons être amenés à communiquer vos données personnelles à nos sous-traitants, comme notre hébergeur ou à des autorités telles que des tribunaux ou police ou officiers ministériels qui peuvent nous demander de divulguer des données personnelles dans le cadre de leur mission.
              </div>

              <h4 className="font-semibold uppercase underline">C. HÉBERGEMENT DES DONNÉES </h4>
              <div class="paragraph">
                  Le site les-detritivores.co est hébergé par la société VERCEL INC.<br />
              </div>

              <h3 className="font-bold uppercase underline">ARTICLE 4 : RESPONSABLE DU TRAITEMENT DES DONNÉES ET DÉLÉGUÉ À LA PROTECTION DES DONNÉES</h3>
              <h4 className="font-semibold uppercase underline">A. LE RESPONSABLE DU TRAITEMENT DES DONNÉES</h4>
              <div class="paragraph">
                  Le responsable du traitement des données à caractère personnel est la société LES DETRITIVORES, SCIC SA au capital de 83 100,00 €, dont le siège social est 65 QUAI DE BRAZZA, 33100 BORDEAUX, immatriculée au numéro suivant : 812 924 538 RCS BORDEAUX, Téléphone : +33(0)5 56 67 14 47, adresse e-mail : bonjour@les-detritivores.co
              </div>
              <div class="paragraph">
                Le responsable du traitement des données détermine les finalités et les moyens mis au service du traitement des données à caractère personnel.
              </div>

              <h4 className="font-semibold uppercase underline">B. OBLIGATIONS DU RESPONSABLE DU TRAITEMENT DES DONNÉES</h4>
              <div class="paragraph">
              ...
              <div class="paragraph">
                  <span class="h4">a. Droit d'accès et de rectification</span><br />
                  L'utilisateur peut prendre connaissance, mettre à jour, ou demander la modification des données le concernant.
              </div>

              <div class="paragraph">
                  <span class="h4">b. Droit d'effacement</span><br />
                  L'utilisateur a le droit de demander la suppression de ses données personnelles lorsque :
                  <ul>
              ...
              Ce droit à l'effacement ne s'applique pas lorsque le traitement des données à caractère personnel est nécessaire :
              ...
              <div class="paragraph">
                  <span class="h4">d. Droit à la limitation et à l'opposition du traitement des données</span><br />
                  L'utilisateur a le droit de demander la limitation du traitement :
                  <ul>
                  <li>pendant une durée nous permettant de vérifier l'exactitude de vos données personnelles,</li>
                  <li>lorsque le traitement est illicite et l'utilisateur s'oppose à l'effacement de ses données personnelles et exige à la place la limitation de leur utilisation,</li>
                  <li>nous n'avons plus besoin des données personnelles mais elles sont encore nécessaires pour la constatation, l'exercice ou la défense de droits en justice de l'utilisateur,</li>
                  <li>pendant la vérification portant sur le point de savoir si les motifs légitimes poursuivis prévalent sur ceux de l'utilisateur lorsqu'il s'est opposé, pour des raisons tenant à sa situation particulière, au traitement de ses données personnelles fondé sur nos intérêts légitimes.</li>
                  </ul>
      L'utilisateur a le droit de s'opposer au traitement de ses données par le site (i) fondé sur nos intérêts légitimes pour des raisons tenant à sa situation particulière et/ou (ii), à des fins de prospection, y compris au profilage dans la mesure où il est lié à une telle prospection, sans que le site ne puisse refuser, sauf à démontrer l'existence de motifs légitimes et impérieux, pouvant prévaloir sur les intérêts et les droits et libertés de l'utilisateur.
      <br /><br />LES DETRITIVORES notifiera l'utilisateur en cas de rectification, d'effacement ou de limitation des données, à moins que cela n'entraîne pour lui des formalités, coûts et démarches disproportionnés.
              </div>

              <div class="paragraph">
                  <span class="h4">e. Droit de ne pas faire l'objet d'une décision fondée exclusivement sur un procédé automatisé</span><br />
              ...
              <div class="paragraph">
                  <span class="h4">f. Droit de déterminer le sort des données après la mort</span><br />
      ...
      Ces directives peuvent être modifiées ou révoquées à tout moment.<br />
      L'utilisateur peut donner :
      <ul>
      <li>des directives générales concernant l'ensemble de ses données personnelles et peuvent être enregistrées auprès d'un tiers de confiance numérique certifié par la CNIL,</li>
      <li>des directives particulières concernant le traitement de ses données personnelles par LES DETRITIVORES et peuvent être enregistrées auprès de nous.</li>
      </ul>
      Pour exercer l'ensemble des droits visés à cet article, l'utilisateur doit adresser sa demande :
      <ul>
      ...
      <li>Par e-mail : bonjour@les-detritivores.co avec pour objet "protection des données".</li>
              ...
              <div class="paragraph">
                  <span class="h4">g. Droit de saisir l'autorité de contrôle compétente</span><br />
              ...
              <h4 className="font-semibold uppercase underline">B. DONNÉES PERSONNELLES DES PERSONNES MINEURES</h4>
              <div class="paragraph">
                  Conformément à la réglementation applicable, seuls les mineurs âgés de 15 ans ou plus peuvent consentir au traitement de leurs données personnelles.<br />
      ...
      L'éditeur du site se réserve le droit de vérifier par tout moyen que l'utilisateur est âgé de plus de 15 ans, ou qu'il aura obtenu l'accord d'un représentant légal avant de naviguer sur le site.
              ...
              <h3 className="font-bold uppercase underline">ARTICLE 6 : UTILISATION DES FICHIERS "COOKIES"</h3>

              <div class="paragraph">
                  Le site a recours aux techniques de "cookies".<br />
                  ...
                  Ce consentement de l'utilisateur est considéré comme valide pour une durée de 13 (treize) mois maximum. A l'issue de cette période, le site demandera à nouveau l'autorisation de l'utilisateur pour enregistrer des fichiers "cookies" sur son disque dur.<br />
              </div>

              <div class="paragraph">
                  <span class="h4">a. Opposition de l'utilisateur à l'utilisation de fichiers "cookies" par le site</span><br />
                  ...
                  <ul>
                  <li><strong>Chrome</strong> : <a href="https://support.google.com/accounts/answer/61416?hl=fr" title="Modifier la gestion des cookies pour le navigateur Chrome">https://support.google.com/accounts/answer/61416?hl=fr</a></li>
                  <li><strong>Firefox</strong> : <a href="https://support.mozilla.org/fr/kb/autoriser-bloquer-cookies-preferences-sites" title="Modifier la gestion des cookies pour le navigateur Firefox">https://support.mozilla.org/fr/kb/autoriser-bloquer-cookies-preferences-sites</a></li>
                  <li><strong>Safari</strong> : <a href="http://www.apple.com/legal/privacy/fr-ww/" title="Modifier la gestion des cookies pour le navigateur Safari">http://www.apple.com/legal/privacy/fr-ww/</a></li>
                  <li><strong>Internet Explorer</strong> : <a href="https://support.microsoft.com/fr-fr/help/17442/windows-internet-explorer-delete-manage-cookies" title="Modifier la gestion des cookies pour le navigateur Internet Explorer">https://support.microsoft.com/fr-fr/help/17442/windows-internet-explorer-delete-manage-cookies</a></li>
                  <li><strong>Opera</strong> : <a href="http://www.opera.com/help/tutorials/security/cookies/" title="Modifier la gestion des cookies pour le navigateur Opera">http://www.opera.com/help/tutorials/security/cookies/</a></li>
                  </ul>
              </div>
              <div class="paragraph">
              ...
              <div class="paragraph">
                  <span class="h4">b. Description des fichiers "cookies" utilisés par le site</span><br />
              ...
              <h3 className="font-bold uppercase underline">ARTICLE 7 : CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ</h3>
              <div class="paragraph">
      ...
      Si elle comporte des modifications importantes nous vous en informerons par tous les moyens.
                  Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le : 26/02/2019.<br />
              </div>

              <h3 className="font-bold uppercase underline">ARTICLE 8 : ACCEPTATION PAR L'UTILISATEUR DE LA POLITIQUE DE CONFIDENTIALITÉ</h3>
              <div class="paragraph">
