      ...
      <div className="pt-3 max-w-lg mx-auto">
        <div className="space-y-6 leading-tight lg:-rotate-3 lg:mt-12">
          <p className="text-2xl font-semibold">
            Nous sommes{' '}
            <span className="p-1 bg-orange-700 font-bold">
              LES&nbsp;DETRITIVORES
            </span>
            .
          </p>
          <p>
            Pionnier.e.s de la gestion des biodéchets depuis 2015, nous trions,
            collectons et valorisons les restes alimentaires... pour en faire un
          ...
          <p>
            Face à leur épuisement, nous régénérons les sols.
            <br />
            Face à la fragilité, nous cultivons les relations.
            <br />
