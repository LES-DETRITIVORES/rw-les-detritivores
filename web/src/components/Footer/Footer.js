  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        <div class="mb-3">
          <div className="uppercase font-bold">Actions organiques</div>
        ...
        <div class="mb-3">
          <div className="uppercase font-bold">Actions inclusives</div>
        ...
        <div class="mb-3">
          <div className="uppercase font-bold">Actions coopératives</div>
        ...
        <div class="mb-3">
          ...
          <a href="/particuliers" className="hover:underline block"><IoHome className="inline mr-1"/>Pour les particuliers</a>
          <a href="/professionnels" className="hover:underline block"><IoRestaurant className="inline mr-1"/>Pour les professionnels</a>
          <a href="/collectivites" className="hover:underline block"><IoBusiness className="inline mr-1"/>Pour les collectivités</a>
        </div>
        <div class="mb-3">
