...
const CooperationPage = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-md md:text-lg text-green-900 font-semibold mb-6"><IoTrailSign className="inline mr-2 align-middle h-6 w-6"/>Vie coopérative > Société Coopérative d'Intérêt Collectif (SCIC)</h1>
