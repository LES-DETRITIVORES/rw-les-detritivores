  ...
  return (
    <>
      <div className="grid grid-cols-1 pt-3 md:grid-cols-2 gap-6">
        <p className="text-2xl font-semibold md:mx-auto md:col-span-2 md:-rotate-3">
          Nous sommes <span className="p-1 bg-orange-700 font-bold">LES&nbsp;DETRITIVORES</span>.
        </p>
        <div className="space-y-6 leading-tight md:-rotate-3 md:mt-6 ">
          <p>
        ...
        <div className="space-y-6 leading-tight md:-rotate-3">
          <p>
